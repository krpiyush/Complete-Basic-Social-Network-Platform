		...
		<div class="main-content">
			...
			<div class="l-part">
				<form action="insert_user.php" method="post">
					...
					<a style="text-decoration: none;float: right;color: #FF5733;" data-toggle="tooltip" title="Signin" href="signin.php">Already have an account?</a><br><br>

					<center><button id="signup" class="btn btn-lg" name="sign_up" style="background-color: #FF5733"><strong style="color: white;">Signup</strong></button></center>
