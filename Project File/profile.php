	...
	<div class="col-sm-8">
		<?php
			...
			<div id='profile-img'>
				...
				<label id='update_profile' class='btn'> Select Profile
...
<div class="row">
	...
	<div class="col-sm-2" style="background-color: #FF5733;text-align: center;left: 0.9%;border-radius: 5px;">
		<?php
		echo"
			<center><h2><strong style='color: white;'>About</strong></h2></center>
			<center><h4><strong style='color: white;'>$first_name $last_name</strong></h4></center>
			<p style='color: white;'><strong ><i>$describe_user</i></strong></p><br>
			<p style='color: white;'><strong >Relationship Status: </strong> $Relationship_status</p><br>
			<p style='color: white;'><strong >Lives In: </strong> $user_country</p><br>
			<p style='color: white;'><strong >Member Since: </strong> $register_date</p><br>
			<p style='color: white;'><strong >Gender: </strong> $user_gender</p><br>
			<p style='color: white;'><strong >Date of Birth: </strong> $user_birthday</p><br>
		";
		?>
	</div>
		...
		<?php
			...
			if($content == "No" && strlen($upload_image) >= 1){
				...
				}else
				{
					...
					<a href='functions/delete_post.php?post_id=$post_id' style='float:right;'><button class='btn btn-danger'>Delete</button></a> </div><br><br>
					";
				}
