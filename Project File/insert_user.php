...
include("includes/db.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$insert = "insert into users (f_name,l_name,user_name,describe_user,relationship,user_pass,user_email,user_country,user_gender,user_birthday,user_image,user_cover,user_reg_date,status,posts,recovery_account,u_music)
		values('$first_name','$last_name','$username','hi there','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','admin','default.mp3')";
